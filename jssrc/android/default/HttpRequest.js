    ...
    if (email === null || password === null) {
        ...
        try {
            ...
            httpRequest.onReadyStateChange = function() {
                HandleResponseSign(httpRequest)
            };
        } catch (exc) {
...
function login() {
    ...
    var password = this.view.txtPasswordLogin.text;
    https: var url = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyCCMR1pmvXBNKWaMCdqowcOO2lXNC9PWrA";
    if (email === null || password === null) {
        alert("Please fill email and password!");
    } else {
        if (flag == 0) {
        ...
        try {
            ...
            //   httpclient2.send();
            httpRequest.onReadyStateChange = function() {
                HandleResponseLogin(httpRequest)
            };
        } catch (exc) {}
    }
}
